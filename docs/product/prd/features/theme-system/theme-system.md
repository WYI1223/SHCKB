...
| **L3 Plugin new theme** | Third-party / Phase 2+ ship（Day-1 reserved，contract 不 M2 lock）| User 装了第三方 theme 且 active | my-theme override presentation attribute；fork lego-studs 后改 palette form；**仍不能改 interaction** |
