...
export const workbench: Theme = {
  ...
  // Curated skins (M6-D3 → unified-block-capability): 'flat' drops the
  // card chrome, content sits directly on the canvas. No defaultSkin —
  // workbench is token-only; falls back to the framework card.
  skins: { flat: flatSkin },
};
